...
// 		$('#code').qrcode(toUtf8("我还会回来的！"));
		...
		function checkPayResult() {
			$.get("/itzixi-maven-ssm-alipay/wxpay/wxPayIsSuccess.action", function(data) {
// 				debugger;
				console.log(data);
				if (data) {
					window.location.href = "/itzixi-maven-ssm-alipay/wxpay/paySuccess.action";
				}
			});
		}
